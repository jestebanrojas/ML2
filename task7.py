...
mnist_svd = TruncatedSVD(n_components=n_componentes)
...
mnist_t_sne = TSNE(n_components=n_componentes, n_iter=250, n_iter_without_progress=50)
...
#mnist_t_sne.fit(X)
# transform the data using the PCA object
#X_transformed = t_sne.tsne(X,num_dimensions=n_componentes)
...
mnist_t_sne = TSNE(n_components=n_componentes, method='exact', n_iter=250, n_iter_without_progress=50)
